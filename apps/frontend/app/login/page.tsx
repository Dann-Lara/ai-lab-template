    ...
    <div className="min-h-screen bg-slate-950 flex">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mb-10">
            <h2 className="headline text-4xl text-white mb-2">{t.auth.loginTitle}</h2>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button type="button" onClick={() => setShowPass(!showPass)}
                  className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-500 hover:text-sky-400
          ...
          <div className="mt-8 space-y-4 text-center">
            <p className="font-mono text-[10px] text-slate-600">
              {t.auth.noAccount}{' '}
              <Link href="/signup" className="text-sky-500 hover:text-sky-400 transition-colors underline underline-offset-4">
                {t.nav.signup}
              </Link>
            </p>
            ...
            <div className="p-3.5 rounded-lg bg-slate-900 border border-slate-800">
              ...
              <button type="button"
                ...
                className="font-mono text-[10px] text-sky-600 hover:text-sky-400 transition-colors">
